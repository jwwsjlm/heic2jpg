...
一个用 Go + Wails 写的 HEIC/HEIF 批量转 JPG 工具，同时保留命令行版本。

## 主要特点

- 提供桌面 GUI：选择文件/文件夹、调整画质、查看进度和结果更直观
...
- GUI 桌面版：`heic2jpg-gui-windows-amd64.zip`、`heic2jpg-gui-macos-universal.tar.gz`、`heic2jpg-gui-linux-amd64.tar.gz`
- CLI 命令行版：`heic2jpg-cli-windows-amd64.zip`、`heic2jpg-cli-linux-amd64.tar.gz`、`heic2jpg-cli-darwin-amd64.tar.gz`、`heic2jpg-cli-darwin-arm64.tar.gz`
...
```bash
go build -tags cli -o heic2jpg-cli .
```
