...
- GUI 桌面版：`heic2jpg-gui-v0.2.4-windows-amd64.zip`、`heic2jpg-gui-v0.2.4-macos-universal.tar.gz`、`heic2jpg-gui-v0.2.4-linux-amd64.tar.gz`
- CLI 命令行版：`heic2jpg-cli-v0.2.4-windows-amd64.zip`、`heic2jpg-cli-v0.2.4-linux-amd64.tar.gz`、`heic2jpg-cli-v0.2.4-darwin-amd64.tar.gz`、`heic2jpg-cli-v0.2.4-darwin-arm64.tar.gz`
...
```bash
go build -tags cli -ldflags "-X main.version=v0.2.4" -o heic2jpg-cli .
```
...
wails build -ldflags "-X main.version=v0.2.4"
```
